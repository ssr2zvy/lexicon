"""process_data_impl.py — wikimedia-audio processing implementation on the shared
framework (common/process_data.py). Run via:
    common/process-data.sh wikimedia-audio [--bg] [--abandon-recent-failed]
...
class Impl(ProcessDataSource):
    ...
    def run(self, session):
        session.log("not implemented yet: processing for wikimedia-audio is pending the "
