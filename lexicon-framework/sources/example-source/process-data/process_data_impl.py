"""process_data_impl.py — youtube-captions processing implementation on the shared
framework (common/process_data.py). Run via:
    common/process-data.sh youtube-captions [--bg] [--abandon-recent-failed]
...
class Impl(ProcessDataSource):
    ...
    def run(self, session):
        session.log("not implemented yet: processing for youtube-captions is pending the "
